          ...
          <div className="container text-center">
            ...
            <div className="lg:hidden">
              <div className="px-4">
                <Carousel className="w-full" opts={{ align: "start" }}>
                  <CarouselContent className="-ml-8 p-4">
                    {features.map((feature, index) => (
                      <CarouselItem key={feature.title} className="pl-8 basis-11/12">
                         <div className="p-1">
            ...
            <div className="hidden lg:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {features.map((feature) => (
                ...
                >
                  <Card className="text-left h-full bg-card/50 rounded-2xl border-0 shadow-primary">
                    <CardHeader className="flex flex-row items-center justify-between">
                       <div className="bg-primary/10 text-primary p-3 rounded-lg">
                        <feature.icon className="h-6 w-6" />
                      </div>
            ...
            <AnimatePresence mode="wait">
              {step === 0 ? (
                ...
                >
                  ...
                  <Card className="max-w-4xl mx-auto p-4 sm:p-6 rounded-2xl bg-card shadow-primary">
                  ...
                  {results && !isCalculating && (
                    <div className="space-y-8">
                      ...
                      <div className="hidden lg:grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                          ...
                          <div className="space-y-8">
                              {results.growthData && results.growthData.length > 0 && (
                              <Card className="rounded-2xl border shadow-primary">
                                  <CardHeader><CardTitle className="text-lg font-bold">Curva de Crescimento</CardTitle></CardHeader>
                                  <CardContent className="pt-2 pl-2">
                                      <div className="h-64 w-full">
                                          <ResponsiveContainer>
                          ...
                          <div className="space-y-8">
                              <div className="grid grid-cols-2 gap-4">
                                  {results.months != null && (
                                    <Card className="bg-primary/5 border-primary/20 text-center shadow-primary"><CardContent className="p-4"><p className="text-sm text-muted-foreground">Tempo até a Meta</p><p className="text-2xl font-bold">{results.months} meses</p></CardContent></Card>
                                  )}
                                  {results.difficultyScore && (
                                    <Card className="bg-primary/5 border-primary/20 text-center shadow-primary"><CardContent className="p-4"><p className="text-sm text-muted-foreground">Nível da Meta</p><p className="text-2xl font-bold">{results.difficultyScore}</p></CardContent></Card>
                                  )}
                              </div>
                               {(results.currentEarnings || results.goalEarnings) && (
                                <Card className="border shadow-primary">
                                  <CardHeader>
                                    <CardTitle className="text-lg font-bold">
                                      Potencial de Ganhos/Mês
                                    </CardTitle>
                              ...
                              {results.benchmarkComparison && (
                                <Card className="border shadow-primary"><CardHeader><CardTitle className="text-lg font-bold">Análise do Mercado</CardTitle></CardHeader><CardContent><p className="text-sm text-muted-foreground">{results.benchmarkComparison}</p></CardContent></Card>
                              )}
                          </div>
                      </div>
                      
                      {results.earningsAnalysis && (
                         <Card className="bg-card border shadow-primary">
                            <CardHeader>
        ...
        <section id="precos" className="py-20 sm:py-24 bg-background">
          <div className="container">
            ...
            <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto items-start">
               {/* Plano Grátis */}
              <Card className="rounded-2xl p-6 flex flex-col h-full bg-muted/30 shadow-primary">
              ...
              {/* Plano Pro */}
              <Card className="rounded-2xl p-6 border-2 border-primary relative flex flex-col h-full shadow-primary">
              ...
              {/* Plano Premium */}
               <Card className="rounded-2xl p-6 border border-yellow-400/50 bg-yellow-400/5 flex flex-col h-full shadow-primary">
